...
describe("Order repository test", () => {
  ...
  it("should update an order", async () => {
    ...
    order.changeOrderItems([ordemItem2]);
  ...
  it("should be able to find an order", async () => {
    ...
    expect(orderResult.items.length).toBe(order.items.length);
  });
  ...
  it("should be able to find all orders", async () => {
    ...
    expect(orderResult[0].items.length).toBe(1);
    expect(orderResult[1].items.length).toBe(1);
  });
